...
class Peserta extends CI_Controller {
  ...
  function peserta_list($trash=0,$id_lomba="")
  {
  	...
  	if(isset($_POST['order'][0]['column'])) $ord = $kolom[$_POST['order'][0]['column']]." ".$_POST['order'][0]['dir'];
		...
		$query = "SELECT * FROM idn_peserta_lomba_member WHERE id_lomba='".$id_lomba."' AND ".$del." AND ".$where." ORDER BY ".$ord." OFFSET ".$_POST['start']." ROWS FETCH NEXT ".$_POST['length']." ROWS ONLY";;
