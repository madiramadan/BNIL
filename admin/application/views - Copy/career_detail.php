				                    ...
				                    <div class="no-p card-body-tab">
				                        <div class="tab-content" id="v-pills-tabContent1">
				                            ...
				                            <div class="tab-pane fade active show" id="w2-tab1" role="tabpanel" aria-labelledby="w2-tab1">
												...
												<div class="form-group form-float">
													<div class="form-line">
														<input name="slug" class="form-control" value="<?php echo isset($val['slug']) ? $val['slug'] : "";?>">
				                            ...
				                            <div class="tab-pane fade" id="w2-tab2" role="tabpanel" aria-labelledby="w2-tab2">
												...
												<div class="form-group form-float">
													<div class="form-line">
														<input name="slug_eng" class="form-control" value="<?php echo isset($val['slug_eng']) ? $val['slug_eng'] : "";?>">
									...
									<div class="">
                            			...
                            			<select name="id_category" class="form-control">
											<?php foreach ($category as $c) { ?>
												<option value="<?php echo $c['id']; ?>" <?php echo isset($val['id_category']) == $c['id'] ? 'selected' : ''; ?> ><?php echo $c['career_category']; ?></option>
											<?php } ?>
										</select>
                          			</div>
                        		</div>
