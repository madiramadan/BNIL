<div class="container-fluid animatedParent animateOnce my-3">
    <div class="animated fadeInUpShort">
        <div class="card" style="background:white;">
        	<div class="col-md-12 p-b-20 text-red"><a class="text-white btn btn-success" href="<?php echo site_url($filez.'/'.$functionz.'_detail/0');?>">Tambah <?php echo $labelz;?></a></div>
    ...
    $('#table-edit').on('click', '.akt', function () {
        ...
        if(confirm('Are your sure '+lbl+' ?')) {
            $.post("<?php echo site_url($filez.'/'.$functionz.'_aktif'); ?>", {
                ...
                window.location = "<?php echo site_url($filez.'/'.$functionz); ?>";
            });
        } else return false;
    });
