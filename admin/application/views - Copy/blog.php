    ...
    <div class="animated fadeInUpShort">
        <div class="card" style="background:white;">
        	<div class="col-md-12 p-b-20 text-red">
        		<a class="text-white btn btn-success" href="<?php echo site_url($filez.'/'.$functionz.'_detail/0');?>">Tambah <?php echo $labelz;?></a>
        		<a class="text-white btn btn-secondary" href="<?php echo site_url($filez.'/'.$functionz.'_import');?>">Import <?php echo $labelz;?></a>
        	</div>
