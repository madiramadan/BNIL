                	...
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_save');?>" enctype="multipart/form-data">
	                	...
	                	<div class="row">
							...
							<div class="col-md-3 box-content box-content-kanan">
								...
								<div class="form-group form-float">
									<div>
                            			<label class="form-label">HTML Form Upload</label>
                            			<input type="file" name="from_html" accept="image/*" class="form-control">
										<?php
										if(isset($val['from_html'])) {
											if(file_exists("../uploads/".$val['from_html']) && $val['from_html']) echo "<br><img src='".str_replace("admin","",base_url())."uploads/".$val['from_html']."' style='max-height:150px;'>";
										}
										?>
                          			</div>
                        		</div>
