<div class="container-fluid animatedParent animateOnce my-3">
    <div class="animated fadeInUpShort">
        <div class="col-md-6 p-b-20" style="float:left;">
      	...
      	<?php if(!$trash) {?>
      		<div class="col-md-6 p-b-20 text-red" style="float:right;text-align:right;"><a class="text-red" href="<?php echo site_url('user/user_detail/0');?>">+ Add New User</a> | <a class="text-red" href="<?php echo site_url('user/main/1');?>">Tempat Sampah</a></div>
      	<?php }?>
