                	...
                	<form class="form-material" method="POST" action="<?php echo site_url('content_custom/content_custom_add');?>" enctype="multipart/form-data">
	                		...
	                		<div class="col-md-8 box-content">
				                            ...
				                            <div class="tab-pane fade active show" id="w2-tab1" role="tabpanel" aria-labelledby="w2-tab1">
				                                <div class="form-group form-float">
								                        ...
								                        <div class="form-group form-float">
								                          ...
								                          <div>
								                            <label class="form-label">Content</label>
								                            <textarea rows="6" name="contents" class="form-control areatext"><?php echo isset($val['contents']) ? $val['contents'] : "";?></textarea>
								                          </div>
								                        </div>
								                      	<?php }?>
				                            ...
				                            <div class="tab-pane fade" id="w2-tab2" role="tabpanel" aria-labelledby="w2-tab2">
				                                <div class="form-group form-float">
								                        ...
								                        <?php } else {?>
								                          ...
								                          <div>
								                            <label class="form-label">Content</label>
								                            <textarea rows="6" name="contents_eng" class="form-control areatext"><?php echo isset($val['contents_eng']) ? $val['contents_eng'] : "";?></textarea>
								                          </div>
								                        </div>
								                      	<?php }?>
								                        <div class="title-box">SEO</div>
					            ...
					            <div class="col-md-3 box-content box-content-kanan">
		                            ...
		                            if(isset($val['file'.$tem])) {
		                            	if(file_exists("../uploads/".$val['file'.$tem]) && $val['file'.$tem]) {
		                            		if(preg_match("/mp4/",$val['file'.$tem])) echo "<br><a href='".str_replace("admin","",base_url())."uploads/".$val['file'.$tem]."'>Video</a>";
		                            		else echo "<br><img src='".str_replace("admin","",base_url())."uploads/".$val['file'.$tem]."' style='max-height:150px;'>";
		                            	}
		                            }
		                            ?>
		                          </div>
                        ...
                        <?php 
		                            ...
		                            if(isset($val['file_mobile'.$tem])) {
		                            	if(file_exists("../uploads/".$val['file_mobile'.$tem]) && $val['file_mobile'.$tem]) {
		                            		if(preg_match("/mp4/",$val['file_mobile'.$tem])) echo "<br><a href='".str_replace("admin","",base_url())."uploads/".$val['file_mobile'.$tem]."'>Video</a>";
		                            		else echo "<br><img src='".str_replace("admin","",base_url())."uploads/".$val['file_mobile'.$tem]."' style='max-height:150px;'>";
		                            	}
		                            }
		                            ?>
		                          </div>
