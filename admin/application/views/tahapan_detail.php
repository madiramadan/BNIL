        	...
        	<div class="card-body p-0">
              <div class="card-box">
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
				                        ...
				                        <div class="tab-content" id="v-pills-tabContent1">
				                                ...
				                                <div class="form-group form-float">
								                        ...
								                        <div class="form-group form-float">
								                          <div>
								                            ...
								                            <textarea rows="2" name="caption" class="form-control areatext"><?php echo isset($val['caption']) ? $val['caption'] : "";?></textarea>
								                          </div>
								                        </div>
								                        <div class="form-group form-float">
								                          <div>
				                            ...
				                            <div class="tab-pane fade" id="w2-tab2" role="tabpanel" aria-labelledby="w2-tab2">
				                                <div class="form-group form-float">
								                        ...
								                        <div class="form-group form-float">
								                          <div>
								                            <label class="form-label">Caption 2 (English)</label>
								                            <textarea rows="2" name="caption_eng" class="form-control areatext"><?php echo isset($val['caption_eng']) ? $val['caption_eng'] : "";?></textarea>
								                          </div>
								                        </div>
								                        <div class="form-group form-float">
								                          <div>
                        ...
                        <div class="form-group form-float">
													<div class="form-line">
														<input name="icon" class="form-control" value="<?php echo isset($val['icon']) ? $val['icon'] : "";?>">
