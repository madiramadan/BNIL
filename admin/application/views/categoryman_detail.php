				                        ...
				                        <div class="tab-content" id="v-pills-tabContent1">
				                            ...
				                            <div class="tab-pane fade active show" id="w2-tab1" role="tabpanel" aria-labelledby="w2-tab1">
												<div class="form-group form-float">
													<div class="form-line">
														<input name="management_category" class="form-control" value="<?php echo isset($val['management_category']) ? $val['management_category'] : "";?>">
														<label class="form-label">Management Category</label>
													</div>
												</div>
											</div>
				                            <!-- TAB ENGLISH -->
				                            <div class="tab-pane fade" id="w2-tab2" role="tabpanel" aria-labelledby="w2-tab2">
												<div class="form-group form-float">
													<div class="form-line">
														<input name="management_category_eng" class="form-control" value="<?php echo isset($val['management_category_eng']) ? $val['management_category_eng'] : "";?>">
														<label class="form-label">Management Category (English)</label>
													</div>
												</div>
				                            </div>
				                        </div>
