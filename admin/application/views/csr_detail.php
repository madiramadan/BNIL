                	...
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
						...
						<div class="col-md-3 box-content box-content-kanan">
							...
							<div class="form-group form-float">
								...
								<select name="csr_cat" class="form-control">
									<option value="gambar" <?php echo isset($val['csr_cat']) && $val['csr_cat']=="gambar" ? "selected" : "";?>>Image</option>
									<option value="video" <?php echo isset($val['csr_cat']) && $val['csr_cat']=="video" ? "selected" : "";?>>Video</option>
								</select>
								</div>
							</div>
							<div class="form-group form-float">
