            ...
            <li class="treeview">
                ...
                <span>Home</span><i class="icon icon-angle-left s-18 pull-right"></i>
           		...
           		<ul class="treeview-menu">
	                ...
	                <li><a href="<?php echo site_url('bnimobile');?>"><i class="icon icon-angle-right s-18"></i>BNI Life Mobile</a></li>
	                <li>
	                	<a href="#">
            ...
            <li class="treeview">
                ...
                <span>Setting</span><i class="icon icon-angle-left s-18 pull-right"></i>
           		...
           		<ul class="treeview-menu">
	                ...
	                <li><a href="<?php echo site_url('admin');?>"><i class="icon icon-angle-right s-18"></i>Manage User</a></li>
