              ...
              <div class="card-box">
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
			                        ...
			                        <div class="tab-content" id="v-pills-tabContent1">
			                                ...
			                                <div class="form-group form-float">
						                        	...
						                        	<div class="form-group form-float">
							                          <div>
							                            ...
							                            <textarea rows="2" name="subtext" class="form-control areatext"><?php echo isset($val['subtext']) ? $val['subtext'] : "";?></textarea>
							                          </div>
							                        </div>
							                        <div class="form-group form-float">
							                          <div class="form-line">
			                            ...
			                            <div class="tab-pane fade" id="w2-tab2" role="tabpanel" aria-labelledby="w2-tab2">
			                                <div class="form-group form-float">
								                      ...
								                      <div class="form-group form-float">
							                          <div>
							                            <label class="form-label">Sub Caption (English)</label>
							                            <textarea rows="2" name="subtext_eng" class="form-control areatext"><?php echo isset($val['subtext_eng']) ? $val['subtext_eng'] : "";?></textarea>
							                          </div>
							                        </div>
							                        <div class="form-group form-float">
							                          <div class="form-line">
							                            <input name="contents_eng" class="form-control" value="<?php echo isset($val['contents_eng']) ? $val['contents_eng'] : "";?>">
						                              <label class="form-label">Button Text</label>
							                          </div>
							                        </div>
			                            </div>
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="back_warna" style="border:1px solid #ddd;width:60px;height:10px;margin-bottom:10px;background:<?php echo isset($val['warna_background']) ? $val['warna_background'] : "#F15922";?>"></div>
                            <select class="form-control back_warna" name="warna_background">
                              <option value="#ffffff" <?php echo isset($val['warna_background']) && $val['warna_background']=="#ffffff" ? "selected" : "";?>>White</option>
                              <option value="#F15922" <?php echo isset($val['warna_background']) && $val['warna_background']=="#F15922" ? "selected" : "";?>>Berwarna</option>
                            </select>
                          </div>
                        </div>
                        <div class="form-group form-float">
...
$(".back_warna").change(function(){
	$(".back_warna").css("background",$(this).val());
});
</script>