              ...
              <div class="card-box">
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
				                                ...
				                                <div class="form-group form-float">
							                        	...
							                        	<div class="form-group">
								                          <div>
								                            ...
								                            <textarea rows="2" name="seo_desc" class="form-control areatext"><?php echo isset($val['seo_desc']) ? $val['seo_desc'] : "";?></textarea>
								                          </div>
								                        </div>
				                            </div>
				                            <!-- TAB ENGLISH -->
				                            <div class="tab-pane fade" id="w2-tab2" role="tabpanel" aria-labelledby="w2-tab2">
				                                <div class="form-group form-float">
							                        	...
							                        	<div class="form-group">
								                          <div>
								                            <label class="form-label">SEO Content</label>
								                            <textarea rows="2" name="seo_desc_eng" class="form-control areatext"><?php echo isset($val['seo_desc_eng']) ? $val['seo_desc_eng'] : "";?></textarea>
								                          </div>
								                        </div>
				                            </div>
				                        </div>
                        ...
                        <div class="form-group form-float">
                            ...
                            <?php
                            $opt_cat=GetOptVideoCat();
                            echo form_dropdown("id_video_cat",$opt_cat,isset($val['id_video_cat']) ? $val['id_video_cat'] : 1,"class='form-control'");
                            ?>
                          </div>
                        </div>
                        <!--<div class="form-group form-float">
