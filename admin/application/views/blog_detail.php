              ...
              <div class="card-box">
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
				                                ...
				                                <div class="form-group form-float">
								                        ...
								                        <div class="form-group form-float">
								                          <div>
								                            ...
								                            <textarea rows="30" id="editor1" class="main-editor" name="contents"><?php echo isset($val['contents']) ? $val['contents'] : "";?></textarea>
								                          </div>
								                        </div>
				                                ...
				                                <div class="form-group form-float">
								                        ...
								                        <div class="form-group form-float">
								                          <div>
								                            ...
								                            <textarea rows="30" id="editor2" class="main-editor" name="contents_eng"><?php echo isset($val['contents_eng']) ? $val['contents_eng'] : "";?></textarea>
								                          </div>
								                        </div>
								                        <div class="title-box">SEO</div>
								                        <div class="form-group form-float">
												...
												<div class="form-group form-float">
													<div>
														...
														<?php if(isset($val['image']) && $val['image']){ ?>
															<img src="<?php echo base_url('../uploads/blog/'.$val['image']); ?>" style="height: 100px;"><br>
														<?php } ?>
												...
												<div class="form-group form-float">
													<div>
														...
														<?php if(isset($val['image_mobile']) && $val['image_mobile']){ ?>
															<img src="<?php echo base_url('../uploads/blog/'.$val['image_mobile']); ?>" style="height: 100px;"><br>
														<?php } ?>
														<span class="badge badge-danger" style="margin-top: 10px;">*File harus berformat JPG, JPEG, atau PNG<span>
													</div>
												</div>
                        ...
                        <div class="form-group form-float">
                            ...
                            <?php
                            $opt_cat=GetOptBlogCat();
                            echo form_dropdown("id_blog_cat",$opt_cat,isset($val['id_blog_cat']) ? $val['id_blog_cat'] : 1,"class='form-control'");
                            ?>
                          </div>
                        </div>
                        <div class="form-group form-float">
