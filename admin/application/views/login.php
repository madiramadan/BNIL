...
<div id="app">
<main>
    <div id="primary" class="p-t-b-100 height-full" style="padding-top:12% !important;background: #006885;background-size: cover;">
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-md-12 white p-40" style="border-radius:5px;">
                           <form class="form-material" action="<?php echo base_url();?>login/cek_login" method="POST">
                                ...
                                <div class="body">
                                    ...
                                    <input type="submit" class="btn btn-danger btn-sm pl-4 pr-4 btn-block" style="background:#f15a24 !important;" value="Log In">
                                </div>
                                <!-- #END# Input -->
                            </form>
                        </div>
