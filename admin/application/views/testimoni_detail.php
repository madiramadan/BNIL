              ...
              <div class="card-box">
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="head_warna" style="border:1px solid #ddd;width:60px;height:10px;margin-bottom:10px;background:<?php echo isset($val['warna_head']) ? "rgba(".$val['warna_head'].",1)" : "#F15922";?>"></div>
                            <select class="form-control warna" name="warna_head">
                              <option value="241,89,34" <?php echo isset($val['warna_head']) && $val['warna_head']=="241,89,34" ? "selected" : "";?>>Orange</option>
                              <option value="247,148,29" <?php echo isset($val['warna_head']) && $val['warna_head']=="247,148,29" ? "selected" : "";?>>Light Orange</option>
                              <option value="1,170,173" <?php echo isset($val['warna_head']) && $val['warna_head']=="1,170,173" ? "selected" : "";?>>Light Tosca</option>
                              <option value="0,103,133" <?php echo isset($val['warna_head']) && $val['warna_head']=="0,103,133" ? "selected" : "";?>>Tosca</option>
                              <option value="153,215,219" <?php echo isset($val['warna_head']) && $val['warna_head']=="153,215,219" ? "selected" : "";?>>Light Blue</option>
                              <option value="12,71,157" <?php echo isset($val['warna_head']) && $val['warna_head']=="12,71,157" ? "selected" : "";?>>Dark Blue</option>
                              <option value="247,247,247" <?php echo isset($val['warna_head']) && $val['warna_head']=="247,247,247" ? "selected" : "";?>>Light Grey</option>
                              <option value="155,155,155" <?php echo isset($val['warna_head']) && $val['warna_head']=="155,155,155" ? "selected" : "";?>>Gray</option>
                              <option value="74,74,74" <?php echo isset($val['warna_head']) && $val['warna_head']=="74,74,74" ? "selected" : "";?>>Dark Grey</option>
                            </select>
                          </div>
                        </div>
                        <div class="form-group form-float">
