...
if (!function_exists('GetMonthFulleng')){	
	function GetMonthFulleng($id)
	{
		$id=intval($id);
...
if (!function_exists('GetOptVideoCat')){	
	function GetOptVideoCat()
	{
		$opt = array();
		$q = GetAll("video_cat", array("is_publish"=> "where/1", "is_delete"=> "where/0"));
		foreach($q->result_array() as $r)
		{
			$opt[$r['id']] = $r['title'];
		}
...
if (!function_exists('Rupiah_ENG')){
	function Rupiah_ENG($rp)
	{
		if($rp && $rp!="-") return "IDR ".number_format($rp,0,",",".").",-";
		else return 0;
	}
}
...
if (!function_exists('Rupiah2')){
	function Rupiah2($rp)
	{
		if($rp && $rp!="-") return " ".number_format($rp,4,",",".")."";
		else return 0;
	}
}

if (!function_exists('Rupiah_ENG2')){
	function Rupiah_ENG2($rp)
	{
		if($rp && $rp!="-") return " ".number_format($rp,4,",",".")."";
		else return 0;
	}
...
if (!function_exists('Rupiah3')){
	function Rupiah3($rp)
	{
		if($rp && $rp!="-") return " ".number_format($rp,2,",",".")."";
		else return 0;
	}
}

if (!function_exists('Rupiah_ENG3')){
	function Rupiah_ENG3($rp)
	{
		if($rp && $rp!="-") return " ".number_format($rp,2,",",".")."";
		else return 0;
	}
...
if (!function_exists('Rupiah_ENG4')){
	function Rupiah_ENG4($rp)
	{
		if($rp && $rp!="-") return " ".number_format($rp,2,",",".")."";
		else return 0;
	}
...
if(!function_exists('GetBahasa')){
    ...
    foreach($q->result_array() as $r) {
		if(getLang())
		{
			$bahasa[$r['id']] = nl2br($r['text_eng']);
		}
		else
		{
			$bahasa[$r['id']] = nl2br($r['text']);
		}
    }
    return $bahasa;
	}
